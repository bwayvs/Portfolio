...
-- Create the TRANSACTION_REVERSAL table.
...
-- Insert records into the TRANSACTION_REVERSAL table.
...
-- Verify insert of records into the TRANSACTION_REVERSAL table.
